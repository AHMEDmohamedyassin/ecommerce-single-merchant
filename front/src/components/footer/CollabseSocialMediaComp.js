...
const CollabseSocialMediaComp = () => {
  ...
  return (
          <div data-animation="collabsecontainer" onClick={() => setDetails(!details)} className=' hover:cursor-pointer'>
            ...
            <ul data-animation="collabsedata" style={{display:"none"}} className='flex p-4 flex-col gap-4'>
                <SocialMediaComp/>
            </ul>
          </div>
  )
