...
<body>
    <div class="flex flex-col items-center w-full">
        ...
        <div class="flex gap-2"><span class="font-bold text-[#c29958]">{{$user?->name}}</span><span>أهلا بك يا</span></div>
        ...
        <a href="{{env('APP_URL') . '/dashboard'}}" class="bg-[#c29958] py-2 px-4 text-lg font-bold rounded-lg my-10">الذهاب للوحة التحكم الخاصة بك</a>

        <a href="{{env('APP_URL')}}" class="text-lg font-bold rounded-lg my-10">الذهاب للصفحة الرئيسية</a>
    </div>
</body>
</html>
