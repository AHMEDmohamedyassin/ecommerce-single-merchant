...
<body class="p-10">
    <div class="flex flex-col justify-center items-center ">
        ...
        <p class="text-lg">اهلا بك يا <span class="font-bold mainTextYellow mx-2"><?php echo e($name); ?></span></p>

        <a href="<?php echo e($url); ?>" class="mainBgYellow py-2 px-4 text-lg font-bold rounded-lg my-10 text-gray-900">اضغط هنا لإعادة تعيين كلمة المرور</a>
...
<?php /**PATH C:\Users\Ahmed\Desktop\ecommerce\laravel\resources\views/Emails/ResetPassword.blade.php ENDPATH**/ ?>