...
<body>
    <div class="flex flex-col items-center w-full">
        ...
        <a href="<?php echo e(env('APP_URL')); ?>" class="text-lg font-bold rounded-lg my-10 bg-[#c29958] px-4 py-2">الذهاب للصفحة الرئيسية</a>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Ahmed\Desktop\ecommerce\laravel\resources\views/EmailVerify/Fail.blade.php ENDPATH**/ ?>